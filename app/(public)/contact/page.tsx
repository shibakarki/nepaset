  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-12 lg:gap-20 items-start">
        ...
        <aside className="space-y-8 lg:sticky lg:top-20">
          ...
          <div className="border-t border-border pt-6 space-y-5">
            ...
            <div className="flex gap-3.5 items-start">
              <div className="w-8 h-8 rounded-lg bg-surface border border-border flex items-center justify-center text-foreground shrink-0 mt-0.5 shadow-sm active:scale-[0.95] transition-transform duration-150">
              ...
              <div>
                <p className="text-[10px] font-bold text-muted uppercase tracking-wider">Call or WhatsApp</p>
                <p className="text-sm font-semibold text-foreground mt-0.5">+977 9744421155</p>
              </div>
            </div>
            ...
            <div className="flex gap-3.5 items-start">
              ...
              <div>
                <p className="text-[10px] font-bold text-muted uppercase tracking-wider">Email Inquiry</p>
                <a href="mailto:nepaset21@gmail.com" className="text-sm font-semibold text-foreground hover:underline mt-0.5 block">nepaset21@gmail.com</a>
              </div>
            </div>
            ...
            <div className="flex gap-3.5 items-start">
              ...
              <div>
                <p className="text-[10px] font-bold text-muted uppercase tracking-wider">Based in</p>
                <p className="text-sm font-semibold text-foreground mt-0.5">Kathmandu, Nepal</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-border pt-6">
            <p className="text-[10px] font-bold text-muted uppercase tracking-wider mb-3">Connect on socials</p>
            <div className="flex gap-2 flex-wrap">
              <a
                href="https://www.instagram.com/nepaset/?utm_source=ig_web_button_share_sheet"
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 border border-border bg-surface text-xs font-semibold rounded-xl text-muted hover:text-foreground hover:border-foreground transition-all active:scale-[0.98] duration-200"
              >
                Instagram
              </a>
              <a
        ...
        <section className="bg-surface border border-border rounded-2xl p-6 md:p-8 shadow-[0_4px_20px_rgba(0,0,0,0.01)]">
          {success ? (
            <div className="py-12 text-center max-w-sm mx-auto space-y-4">
              <div className="w-12 h-12 bg-surface-2 border border-border rounded-full flex items-center justify-center mx-auto text-base text-foreground font-semibold shadow-inner">
                ✓
              </div>
              ...
              <button
                ...
                className="mt-2 text-xs font-semibold hover:underline active:scale-[0.98] transition-transform cursor-pointer"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs text-muted mb-1.5 font-medium">Phone Number <span className="text-muted/60 font-normal">(optional)</span></label>
                  <input
                    type="tel"
                    value={form.phone}
                ...
                <div>
                  <label className="block text-xs text-muted mb-1.5 font-medium">Subject</label>
                  <input
                    type="text"
                    value={form.subject}
              ...
              <div>
                <label className="block text-xs text-muted mb-1.5 font-medium">Message</label>
                <textarea
                  value={form.message}
              ...
              <button
                type="submit"
                disabled={sending}
                className="w-full py-3.5 bg-foreground text-background font-space text-sm font-semibold rounded-xl hover:opacity-90 active:scale-[0.98] shadow-md shadow-foreground/5 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
